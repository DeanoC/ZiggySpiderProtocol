...
export type ControlMessageType = typeof controlMessageTypes[number];

export const acheronMessageTypes = [
  "acheron.t_version",
  "acheron.r_version",
  "acheron.t_attach",
  "acheron.r_attach",
...
export type AcheronMessageType = typeof acheronMessageTypes[number];

export const runtimeAcheronMessageTypes = [
  "acheron.t_version",
  "acheron.r_version",
  "acheron.t_attach",
  "acheron.r_attach",
...
export const nodeFsAcheronMessageTypes = [
  "acheron.t_fs_hello",
  "acheron.r_fs_hello",
  "acheron.t_fs_exports",
  "acheron.r_fs_exports",
...
export const legacyRejectedControlMessageTypes = [
  "session.send",
...
export const legacyRejectedAcheronMessageTypes = [
  "acheron.t_hello",
  "acheron.fs_t_*",
  "acheron.fs_r_*",
  "acheron.fs_evt_*",
...
export type Channel = "control" | "acheron";
export type ProtocolEnvelopeRule =
  | "channel-required"
  | "type-must-match-channel"
  | "legacy-names-rejected"
  | "correlation-by-id-or-tag";
export const protocolEnvelopeRules: readonly ProtocolEnvelopeRule[] = [
  "channel-required",
  "type-must-match-channel",
  "legacy-names-rejected",
  "correlation-by-id-or-tag",
